# Vault Monitor — 2026-03-23 r25

**Timestamp:** 2026-03-23 ~04:52 UTC
...
## Flags
- 🔴 **Beast SSH DOWN** — Connection refused on port 22. No SSH key found in Cowork session environment (`~/.ssh/` empty). Beast unreachable since r18 (~03:42 UTC), now ~80 min. Last confirmed up at r17 (~03:32 UTC). Intermittent SSH drops observed all day.
