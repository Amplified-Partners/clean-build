...
## Flags
- **⚠️ BEAST SSH DOWN — EXTENDED OUTAGE** — `ssh: connect to host 135.181.161.131 port 22: Connection refused`. SSH key not found in this Cowork session environment. Down since ~R49 with brief restoration at R71, down again R72–R80. **Prolonged outage spanning 30+ runs.** sshd or firewall on Beast needs manual investigation.
