...
## Flags
- **⚠️ BEAST SSH DOWN — EXTENDED OUTAGE** — `ssh: connect to host 135.181.161.131 port 22: Connection refused`. SSH key also missing from Cowork session. Down since ~R49 with brief restoration at R71, down again R72–R81. **31+ consecutive failed runs.** sshd or firewall on Beast needs manual investigation.
