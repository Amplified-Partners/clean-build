...
## Flags
- 🔴 **Beast SSH unreachable from sandbox** — persistent since ~R49 (~14+ hours). SSH key missing from sandbox environment. Needs Ewan to verify manually or place key in accessible location.
