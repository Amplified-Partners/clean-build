...
## Flags
- **⚠️ BEAST SSH DOWN — EXTENDED OUTAGE** — `ssh: connect to host 135.181.161.131 port 22: Connection refused`. Down since ~R49 with brief restoration at R71, down again R72–R78. Prolonged outage spanning 29+ runs. Tried both SSH keys and port 2222 — all refused/timed out. sshd or firewall on Beast needs manual investigation.
