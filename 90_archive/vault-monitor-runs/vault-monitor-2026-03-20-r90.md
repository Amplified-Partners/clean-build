# Vault Monitor — 2026-03-20 r90 (UTC)

## 1. Claude Code Output
- **_working/**: 89 monitor reports today (r1–r89). No other new files.
...
## Flags
- **CRITICAL: Beast SSH DOWN — persisting since r86 (~1hr+).** Port 22 connection refused. Not an auth issue — the port itself is refusing connections. Likely SSH service crash, firewall change, or server reboot. Needs manual investigation via Hetzner console.
