...
- **Where encoded**: `Amplified-Partners/cost-tools#2` (Linux portability patch + Dockerfile + docker-compose + RUNBOOK + README); `01_truth/SYSTEMS-AND-API-REGISTER.md` v2; `02_build/INFRASTRUCTURE.md` v2; `00_authority/MANIFEST.md` v45; `03_shadow/job-wrapups/2026-05-03_cost-tools-resurrection_v1.md`.
...
- **Where encoded**: `00_authority/AGENT_ROUTING.md` v1; `00_authority/MANIFEST.md` v45 § Authoritative now.
