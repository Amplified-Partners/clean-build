...
id: "business_asset_audit_phase1"
version: 1
created: "2026-04-25"
type: "document"
topic_type: "audit"
...
#### Key Features:
- **Routing Logic:** PII-containing tasks â†’ local models, others â†’ cloud
- **Policy Enforcement:** Auto-approval for high confidence (â‰¥0.9), manual review otherwise
...
- ChromaDB â‰¥0.5.23 (vector storage)
- Sentence-Transformers â‰¥3.3.1 (embeddings)
- Pydantic â‰¥2.10.4
- Rich â‰¥13.9.4 (CLI)
...
#### LLM APIs
- **anthropic** (â‰¥0.18.0, â‰¥0.40.0) - Anthropic Claude API client
- **google-generativeai** - Google Gemini API client
- **openai** - OpenAI API client (referenced)

#### Machine Learning
- **sentence-transformers** (â‰¥3.3.1) - Text embeddings (interior-design)
- **torch** (â‰¥2.0.0) - PyTorch for ML operations
- **numpy** - Numerical computing

#### Vector Storage
- **chromadb** (â‰¥0.5.23) - Vector database for semantic search
- **tiktoken** (â‰¥0.5.2) - Token counting

### 6.3 Database and ORM

#### Relational Databases
- **SQLAlchemy** (â‰¥2.0.25) - ORM for lead-engine
...
#### Web Scraping
- **requests** (â‰¥2.31.0, â‰¥2.32.0) - HTTP library
- **beautifulsoup4** (â‰¥4.12.0) - HTML parsing
- **lxml** (â‰¥5.0.0, â‰¥5.3.0) - Fast XML/HTML parser
- **selenium** (â‰¥4.27.0) - Dynamic content scraping
- **playwright** (â‰¥1.40.0) - Browser automation

#### HTTP Clients
- **httpx** (â‰¥0.28.1) - Async HTTP client
...
#### Testing Frameworks
- **pytest** (â‰¥8.0.0, â‰¥8.3.4) - Testing framework
- **pytest-asyncio** (â‰¥0.23.0) - Async testing support
- **pytest-mock** (â‰¥3.12.0) - Mock support
...
#### Terminal UI
- **rich** (â‰¥13.7.0, â‰¥13.9.4) - Rich terminal output
- **click** (â‰¥8.1.7) - CLI framework
- **questionary** (â‰¥2.0.1) - Interactive prompts
...
**Status:** âœ… GOOD (Agentic Workflow)
...
**Status:** âš ï¸ OPTIONAL (Not Enforced)
...
â”œâ”€â”€ agentic_workflow/                  # Minimal agentic workflow scaffold
â”‚   â”œâ”€â”€ agents/                        # Task, Policy, Librarian agents
â”‚   â”œâ”€â”€ api/                           # FastAPI REST API
â”‚   â”œâ”€â”€ security/                      # PII detection, encryption
...
â”‚
â”œâ”€â”€ interior-design-system/            # Professional interior design workflow
â”‚   â”œâ”€â”€ agents/                        # 6 AI agents (Discovery, Style, etc.)
â”‚   â”œâ”€â”€ rag/                           # RAG pipeline (search, embeddings, vectors)
â”‚   â”œâ”€â”€ scrapers/                      # IKEA, AliExpress, 1688 scrapers
â”‚   â”œâ”€â”€ models/                        # Pydantic schemas
â”‚   â”œâ”€â”€ cli/                           # CLI interfaces
â”‚   â”œâ”€â”€ tests/                         # Comprehensive test suite
â”‚   â”œâ”€â”€ utils/                         # Config, currency, anthropic client
â”‚   â”œâ”€â”€ .env.example                   # Environment template
â”‚   â”œâ”€â”€ requirements.txt               # 27 dependencies
â”‚   â”œâ”€â”€ pyproject.toml                 # Project configuration
â”‚   â””â”€â”€ README.md                      # 977-line comprehensive guide
â”‚
â”œâ”€â”€ lead-engine/                       # Enterprise lead generation platform
â”‚   â”œâ”€â”€ clients/                       # Perplexity, Claude API clients
â”‚   â”œâ”€â”€ services/                      # Research, diagnosis, email services
...
â”‚   â”œâ”€â”€ .env.example                   # Environment template
â”‚   â”œâ”€â”€ requirements.txt               # Dependencies
â”‚   â””â”€â”€ VALIDATION_LOG.md              # 2600+ line development log
â”‚
â”œâ”€â”€ melanin-design-platform/           # Full-stack web application
â”‚   â”œâ”€â”€ backend/                       # Express.js backend
â”‚   â”œâ”€â”€ frontend/                      # React frontend
â”‚   â””â”€â”€ [extensive structure...]
â”‚
â”œâ”€â”€ ai-audit-scripts/                  # AI cost monitoring scripts
â”œâ”€â”€ files/                             # Architecture and setup documentation
â”œâ”€â”€ 00-system/                         # Master prompts and workflows
â””â”€â”€ [many additional files...]
```
