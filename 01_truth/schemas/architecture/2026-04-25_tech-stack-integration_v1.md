...
|----------|-------------|-------|-------------|------------|
| **Xero** | 25-30% | Â£12-70/mo | Growing SMBs | Excellent |
| **Sage** | 20-25% | Â£14-200+/mo | Established, accountants | Good |
| **QuickBooks Online** | 15-20% | Â£10-50/mo | Service-based | Excellent |
| **FreshBooks** | 8-12% | Â£15-40/mo | Freelancers, time-tracking | Good |
| **Tide** | 5-8% | Â£9.99/mo | Micro-businesses | Limited |
...
**Total they spend:** Â£2,500-4,000/month (tools + admin staff doing manual work)
...
**Total hidden cost of these gaps:** Â£1,500-2,500/month in lost productivity + frustrated customers
...
Owner sees: Draft reply, clicks âœ“ Send or edits it
...
- If they just have mobile: Recommend move to Vonage (Â£20-30/mo total cost drop)
...
Phone rings â†’ Dashboard shows customer name + history
Agent answers â†’ Call recorded & transcribed in real-time
Customer: "The invoice I got on Tuesday was wrong"
System captures: Issue type, action needed
Call ends â†’ CRM auto-updated: "Customer complained about invoice, reissued corrected version"
Manager sees: Call summary, action taken, issue resolved
Next time customer calls â†’ Agent sees full history (not start from scratch)
```
...
- Hook works: Average Â£2,400/month found

**Months 5-8: Upsell Phase 2-3 (Systems + Single Inbox)**
- Core Tier 3: Â£1,200/month (systems building)
...
- Add-on: +Â£300/month (total: Â£1,500/month)
...
- Premium module: +Â£300-400/month (total: Â£1,800-1,900/month)
...
- Email: Â£10/month
- CRM: Â£40/month
- Zoom Phone: Â£20/month
- Manual admin: Â£2,000-3,000/month
- **Total: Â£2,100-3,100/month (mostly wasted on admin)**

### Your Package (Phased)

**Month 1-4:** Â£2,500 (one-time Tier 1)
**Month 5+:** Â£1,200/month (Tier 3 - systems building)
**Month 9+:** Â£1,500/month (Tier 3 + Single Inbox + AI responses)
**Month 13+:** Â£1,800/month (Tier 3 + Full Comms Stack)

**Their ROI:**
- Saves Â£2,000-3,000/month (admin time eliminated)
- Your cost: Â£1,800/month
- **Net profit increase: Â£200-1,200/month from your service alone**
...
**Competitors:**
- Ring Central: Â£20-50/month (just phone)
- HubSpot: Â£45-1,200+/month (just CRM)
- Zapier: Â£20-299/month (just automation)
- Freshbooks: Â£15-70/month (just accounting)
...
|-------|-------|---------|---------|--------|
| 1-4 | Foundation | Â£7,500 (one client Tier 1) | 1 | None |
| 5-8 | Phase 2 (Inbox) | Â£6,000 (5 Tier 3) | 5 | None yet |
| 9-12 | Phase 3 (AI Responses) | Â£6,000 base + Â£1,500 add-on (1 upsells) | 5-6 Tier 3 | Comms (1 client) |
| 13+ | Phase 4 (Telephony) | Â£6,000 base + Â£3,000 add-ons | 5-6 Tier 3 | Comms (2-3 clients) |

**By Month 12:**
- Base Tier 3 revenue: Â£6,000/month (5 clients Ã— Â£1,200)
- Add-on revenue: +Â£3,000/month (comms modules)
- **Total: Â£9,000/month (on top of Tier 1/2 sales)**

**Annual profit from recurring (Tier 3 only):** Â£90,000+
...
â”œâ”€ Xero (accounting)
â”œâ”€ Gmail (email)
â”œâ”€ Google Calendar (scheduling)
â”œâ”€ HubSpot/Pipedrive (CRM)
â””â”€ Possibly: Vonage/RingCentral (phone)
         â†“
YOUR INTEGRATION LAYER (n8n or custom)
â”œâ”€ Data extraction (APIs pull data)
â”œâ”€ Transformation (normalize data)
â”œâ”€ Intelligence (Claude AI for analysis)
â””â”€ Orchestration (trigger actions)
         â†“
YOUR UNIFIED DASHBOARD
â”œâ”€ Financial analytics
â”œâ”€ Unified inbox (email + SMS + WhatsApp)
â”œâ”€ AI-suggested responses
â”œâ”€ Call recording + transcription (if Phase 4)
â””â”€ Performance tracking
         â†“
CLIENT SEES
â”œâ”€ Dashboard (one place to manage everything)
â”œâ”€ Integrations (their tools work seamlessly)
â””â”€ Results (faster responses, better service, profit)
```
...
By Month 6, you'll have a replicable comms module ready to upsell to all Tier 3 clients at +Â£300-500/month.

That's an extra Â£1,500-2,500/month per 5 clients who take it.

**At 50% uptake rate:** +Â£4,500/month by Month 12
