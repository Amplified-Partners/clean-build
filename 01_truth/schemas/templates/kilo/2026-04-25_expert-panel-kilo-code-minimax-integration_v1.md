...
id: "expert-panel-kilo-code-minimax-integration"
version: 1
created: "2026-04-25"
type: "document"
...
TARGET AUDIENCE: [e.g., "UK SMBs, Â£500K-3M revenue, owner-operators"]
...
FORMAT YOUR OUTPUT:
ðŸŽ¯ CONVERSION SCORE: [Score]/10

[Issue 1]: [Impact] â†’ [Specific fix]
[Issue 2]: [Impact] â†’ [Specific fix]
[Issue 3]: [Impact] â†’ [Specific fix]
...
2. How many clicks to reach major pages? (Target: â‰¤3)
...
FORMAT YOUR OUTPUT:
ðŸ˜Š UX SCORE: [Score]/10

Navigation: [Analysis of how intuitive it is]

[Issue 1]: [What confuses users] â†’ [Fix]
[Issue 2]: [What confuses users] â†’ [Fix]
[Issue 3]: [What confuses users] â†’ [Fix]
...
4. Rank issues by priority (impact Ã— effort)
...
## WORKFLOW: CRITIQUE â†’ BUILD â†’ ITERATE

### Day 1: Run Expert Panel (10 min)
```
Input website URL â†’ MiniMax analyzes with 8 experts â†’ Report generated
...
Normally, hiring these 8 experts would cost Â£5,000-8,000.

With our AI-powered panel, you get a full critique in 10 minutes for Â£1,997.
...
4. **Scalability:** Same system works for Â£1K websites and Â£100K websites
